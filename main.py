...
class LockScreen(MDScreen):
    def __init__(self, **kwargs):
        ...
        self.add_widget(MDLabel(text="SYSTEM LOCKED", halign="center", pos_hint={"center_y":0.6}, theme_text_color="Custom", text_color=(0,0.7,1,1)))
        self.add_widget(MDRaisedButton(text="ENTER ACCESS CODE", pos_hint={"center_x":0.5, "center_y":0.4}, on_release=lambda x: self.check_auth()))
...
class MainScreen(MDScreen):
    def __init__(self, **kwargs):
        ...
        layout.add_widget(MDLabel(text="SHADOW MONARCH ACTIVE", halign="center", theme_text_color="Custom", text_color=(0,1,0,1)))
        self.add_widget(layout)
